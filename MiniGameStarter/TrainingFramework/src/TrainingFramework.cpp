...
int Globals::screenWidth = 1332;
int Globals::screenHeight = 999;
...
GLint _tmain(GLint argc, _TCHAR* argv[])
{
	...
	esCreateWindow(&esContext, "Broken Game", Globals::screenWidth, Globals::screenHeight, ES_WINDOW_RGB | ES_WINDOW_DEPTH);
	if (Init(&esContext) != 0)
		return 0;
