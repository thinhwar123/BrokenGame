...
AnimationSprite::AnimationSprite() :Sprite2D(), m_numFrames(0), m_currentFrame(0), m_frameTime(0.0f), m_currentFrameTime(0.0f)
{
}
...
AnimationSprite::AnimationSprite(std::shared_ptr<Model> model, std::shared_ptr<Shader> shader, std::shared_ptr<Texture> texture, int numFrame, float frameTime)
	: Sprite2D(-1, model, shader, texture), m_numFrames(numFrame), m_currentFrame(0), m_frameTime(frameTime), m_currentFrameTime(0.0f)
{
